<?php
// started with dynamic_ajax_php.php from jCarousel example
// and modified it with my filelist.php code to read from
// any server, not just local

include("thc_filelist.inc.php");  // Tom Carlson function to get a list of files
...
$location =  $_GET["fileurl"];
//$location = "http://images.pagesalt.com";
//$location = "http://tomcarlson.com/images";
//$location = "/imagerotate";

$fileextensions = array("png", "jpg", "gif");

$images = thc_filelist($location);
$images = keep_extensions($images,$fileextensions);  // keep only graphic files
